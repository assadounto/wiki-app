              ...
              {status.items.map((key) => (
                <div className="Pollution-info" key={key.nitro}>
                  <div className="Quality">
                    Air Quality
                    {key.AirQuality === 1 ? <div className="G C">Good</div> : 2 ? <div className="G C">fair</div> : 3 ? <div className="B C">moderate</div> : 4 ? <div className="R C">poor</div> : <div className="R C">very poor</div>}
